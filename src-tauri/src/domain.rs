...
pub struct Project {
    ...
    /// Providers represented by this workspace.  Kept separate from `id` so
    /// legacy Claude project IDs remain stable while UI keys can namespace
    /// projects by provider when a fallback workspace is used.
    #[serde(default)]
    ...
    /// Provider metadata and session grouping for the Project → Agent model.
    #[serde(default)]
...
/// A Context is the provider-neutral conversation detail read model.
pub type Context = SessionDetail;
...
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct KnowledgeCardPatch {
    pub title: Option<String>,
    pub summary: Option<String>,
    pub tags: Option<Vec<String>>,
    pub body_markdown: Option<String>,
    pub source_session_ids: Option<Vec<String>>,
}
